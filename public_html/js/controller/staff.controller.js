/**
 * js/controller/staff.controller.js
...
class StaffController {
    ...
    openStaffModal(id = null) {
        ...
        if (id) {
            ...
            if (avatarPreview) avatarPreview.src = 'https://ui-avatars.com/api/?name=User&background=random&size=128';
    ...
    async executeDelete() {
        ...
        btn.disabled = true;
        let res;
        if (type === 'staff') { res = await staffService.delete(id); }
